...
\usepackage{cleveref}
\newcommand{\crefnames}[2]{%
  \crefname{#1}{#2}{#2}%
  \Crefname{#1}{#2}{#2}%
}

\crefnames{section}{Section}
\crefnames{figure}{Figure}
\crefnames{table}{Table}
\crefnames{definition}{Definition}
\crefnames{lemma}{Lemma}
\crefnames{theorem}{Theorem}
\crefnames{proposition}{Proposition}
\crefnames{corollary}{Corollary}
